	...
	<div class="col-lg-12">
		<section class="panel">
			<header class="panel-heading">
                Creative Artist Sub-Category Album Details<a class="btn btn-primary pull-right"  href="<?php echo site_url('site/createphotographeralbumgallery?id=').$this->input->get('id'); ?>"><i class="icon-plus"></i>Create </a>
                <a class="btn btn-primary pull-right savemainphotographeralbumgalleryorder">Save Order</a>
...
<!--                              <div><span class="badge"><?php if($row->type==1){ echo "Horizontal "; } else { echo "Verticle "; } ?></span></div>-->
                              ...
                              <div class="col-md-2"><a href="<?php echo site_url('site/editphotographeralbumgallery?id=').$row->photographeralbum.'&photographeralbumgalleryid='.$row->id;?>" class="btn btn-primary btn-xs">
...
<script>
  ...
  $(this).attr("data-order",index+1);
    ...
    $(".savemainphotographeralbumgalleryorder").click(function () {
        $("#sortable>li").each(function( index ) {
            
        $.getJSON(
            "<?php echo base_url(); ?>index.php/site/savemainphotographeralbumgalleryorder?order="+$(this).attr("data-order")+"&id="+$(this).attr("data-id")+"", {
