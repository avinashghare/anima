...
<li><a href="<?php echo site_url('site/viewphotographeralbumgalleryimage?photographeralbumgalleryid=').$before->id."&id=".$before->photographeralbum; ?>">Gallery Images</a></li>
