	...
	<div class="col-lg-12">
		<section class="panel">
			<header class="panel-heading">
                Creative Artist Album Details<a class="btn btn-primary pull-right" href="<?php echo site_url("site/createphotographeralbum"); ?>"><i class="icon-plus"></i>Create </a>
                <a class="btn btn-primary pull-right savemainphotographeralbumorder">Save Order</a>
...
<!--                              <div><span class="badge"><?php if($row->type==1){ echo "Horizontal "; } else { echo "Verticle "; } ?></span></div>-->
                              ...
                              <div class="col-md-2"><a href="<?php echo site_url('site/editphotographeralbum?id=').$row->id;?>" class="btn btn-primary btn-xs">
								<i class="icon-pencil"></i>
							</a>
							<a href="<?php echo site_url('site/deletephotographeralbum?id=').$row->id; ?>" class="btn btn-danger btn-xs">
...
<script>
  ...
  $(this).attr("data-order",index+1);
    ...
    $(".savemainphotographeralbumorder").click(function () {
        $("#sortable>li").each(function( index ) {
            
        $.getJSON(
            "<?php echo base_url(); ?>index.php/site/savemainphotographeralbumorder?order="+$(this).attr("data-order")+"&id="+$(this).attr("data-id")+"", {
