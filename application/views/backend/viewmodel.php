	...
	<div class="col-lg-12">
		<section class="panel">
			<header class="panel-heading">
                Model Details<a class="btn btn-primary pull-right" href="<?php echo site_url("site/createmodel"); ?>"><i class="icon-plus"></i>Create </a>
                <a class="btn btn-primary pull-right savemainmodelorder">Save Order</a>
...
<!--                              <div><span class="badge"><?php if($row->type==1){ echo "Horizontal "; } else { echo "Verticle "; } ?></span></div>-->
                              ...
                              <div class="col-md-2"><a href="<?php echo site_url('site/editmodel?id=').$row->id;?>" class="btn btn-primary btn-xs">
								<i class="icon-pencil"></i>
							</a>
							<a href="<?php echo site_url('site/deletemodel?id=').$row->id; ?>" class="btn btn-danger btn-xs">
...
<script>
  ...
  $(this).attr("data-order",index+1);
    ...
    $(".savemainmodelorder").click(function () {
        $("#sortable>li").each(function( index ) {
            
        $.getJSON(
            "<?php echo base_url(); ?>index.php/site/savemainmodelorder?order="+$(this).attr("data-order")+"&id="+$(this).attr("data-id")+"", {
